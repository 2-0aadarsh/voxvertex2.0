...
const Step3: React.FC<Step3Props> = ({
  ...
  const [speakerFeeAmount, setSpeakerFeeAmount] = useState('0');
  ...
  useEffect(() => {
    if (formData.offerAmount) {
      // Assuming offerAmount is sum of both, initialize honorariumAmount only for now
      setHonorariumAmount(formData.offerAmount.toString());
    }
  ...
  const handleNext = () => {
    const speakerAmountNum = parseInt(speakerFeeAmount) || 0;
    const honorariumAmountNum = parseInt(honorariumAmount) || 0;

    const totalAmount = speakerAmountNum + honorariumAmountNum;
          ...
          <div className="flex justify-center">
            <div className="flex items-center">
              <div className="flex flex-col items-center">
                ...
                <span className="mt-2 text-sm font-medium text-gray-900 text-center whitespace-nowrap">
                  Date & Time
                </span>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="mt-2 text-sm text-gray-500 text-center whitespace-nowrap">
                  Review & Send
                </span>
              </div>
            </div>
        ...
        <div className="p-8">
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-sm">
              Define the compensation and additional arrangements for your speaker.
            </p>
          </div>
          ...
          <div className="border border-[#FF6B35] rounded-lg p-6 mb-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div
                  className={`border rounded-lg p-4 cursor-pointer transition-all ${
                    speakerFeeSelected ? 'border-[#FF6B35] bg-[#FF6B35]/5' : 'border-gray-200 hover:border-gray-300'
                  }`}
                  ...
                  <div className="flex items-center">
                    <div
                      className={`w-4 h-4 rounded border-2 mr-3 flex items-center justify-center ${
                        speakerFeeSelected ? 'border-[#FF6B35] bg-[#FF6B35]' : 'border-gray-300'
                      }`}
                    >
                      {speakerFeeSelected && (
                        <svg
                ...
                <div
                  className={`border rounded-lg p-4 cursor-pointer transition-all ${
                    honorariumSelected ? 'border-[#FF6B35] bg-[#FF6B35]/5' : 'border-gray-200 hover:border-gray-300'
                  }`}
                ...
                >
                  <div className="flex items-center">
                    <div
                      className={`w-4 h-4 rounded border-2 mr-3 flex items-center justify-center ${
                        honorariumSelected ? 'border-[#FF6B35] bg-[#FF6B35]' : 'border-gray-300'
                      }`}
                    >
                      {honorariumSelected && (
                        <svg
            ...
            {/* Input fields separately for speaker fee and honorarium */}
            <div
              className="grid gap-4"
              style={{
                gridTemplateColumns:
                  speakerFeeSelected && honorariumSelected ? '1fr 1fr' : '1fr',
              }}
            >
              {speakerFeeSelected && (
                <div>
                ...
                <div className="px-4 pb-4">
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="relative">
                      ...
                      <label className="absolute -top-2 left-3 bg-white px-1 text-xs text-[#FF6B35]">
                        Travel Mode <span className="text-[#FF6B35]">*</span>
                      </label>
                    </div>
                  ...
                  <div className="relative">
                    ...
                    <label className="absolute -top-2 left-3 bg-white px-1 text-xs text-[#FF6B35]">
                      Amount <span className="text-[#FF6B35]">*</span>
                    </label>
                  </div>
                </div>
              )}
                ...
                <div className="px-4 pb-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div className="relative">
                      ...
                      {checkInDate && (
                        <div className="mt-1 text-xs text-gray-500">{formatDateForDisplay(checkInDate)}</div>
                      )}
                    </div>
                    ...
                    <div className="relative">
                      ...
                      {checkOutDate && (
                        <div className="mt-1 text-xs text-gray-500">{formatDateForDisplay(checkOutDate)}</div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div
                      className={`border-1 border-[#FF6B35] rounded-lg p-4 cursor-pointer transition-all ${
                        localTransportation ? 'bg-[#FF6B35]/5' : 'hover:bg-gray-50'
                      }`}
                    ...
                    <div
                      className={`border-1 border-[#FF6B35] rounded-lg p-4 cursor-pointer transition-all ${
                        meals ? 'bg-[#FF6B35]/5' : 'hover:bg-gray-50'
                      }`}
