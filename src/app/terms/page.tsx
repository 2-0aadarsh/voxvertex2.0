    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-r from-[#FF6B35] to-[#de3b00] min-h-[300px] sm:min-h-[350px] md:h-76 flex items-center justify-center px-4 py-8 sm:py-12">
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto">
          ...
          <p className="text-base sm:text-lg mb-3 sm:mb-4 px-4">Your trust and security are at the heart of everything we do.</p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">1. Introduction & Agreement to Terms</h2>
          <p className="text-sm sm:text-md text-gray-700 leading-relaxed mb-4">
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">2. The Voxvertex Platform</h2>
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 p-3 sm:p-4 rounded-lg">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Event Organizers ("Organizers")</h3>
              <p className="text-xs sm:text-sm text-gray-700">Users who create, manage, and promote events.</p>
            </div>
            <div className="bg-gray-50 p-3 sm:p-4 rounded-lg">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Speakers</h3>
              <p className="text-xs sm:text-sm text-gray-700">Professional users who offer their speaking and related services to Organizers.</p>
            </div>
            <div className="bg-gray-50 p-3 sm:p-4 rounded-lg">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Participants ("Attendees")</h3>
              <p className="text-xs sm:text-sm text-gray-700">Users who purchase tickets to attend events created by Organizers.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">3. User Accounts & Verification</h2>
          <div className="space-y-4 sm:space-y-6">
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3">Account Creation</h3>
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3">Account Security</h3>
              <p className="text-xs sm:text-sm text-gray-700">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3">Identity Verification (KYC/KYB)</h3>
              <p className="text-xs sm:text-sm text-gray-700">
        ...
        {/* Financial Terms */}
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">4. Financial Terms</h2>
          <p className="text-sm sm:text-md text-gray-700 leading-relaxed mb-4 sm:mb-6">
          ...
          <div className="space-y-6 sm:space-y-8">
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">A. For Event Organizers</h3>
              <ul className="text-xs sm:text-sm text-gray-700 space-y-3 pl-2">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">B. For Speakers</h3>
              <ul className="text-xs sm:text-sm text-gray-700 space-y-3 pl-2">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">C. For Participants</h3>
              <ul className="text-xs sm:text-sm text-gray-700 space-y-3 pl-2">
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">5. The "Engineered Trust" Escrow System</h2>
          <p className="text-sm sm:text-md text-gray-700 leading-relaxed mb-4">
            The escrow system is a core feature designed to protect both Organizers and Speakers.
          </p>
          <ul className="text-xs sm:text-sm text-gray-700 space-y-2 pl-2">
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">6. User Conduct & Content</h2>
          <div className="space-y-4 sm:space-y-6">
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3">Content Ownership</h3>
              <p className="text-xs sm:text-sm text-gray-700">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3">Acceptable Use</h3>
              <p className="text-xs sm:text-sm text-gray-700">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3">Platform Monitoring</h3>
              <p className="text-xs sm:text-sm text-gray-700">
        ...
        {/* Dispute Resolution */}
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">7. Dispute Resolution</h2>
          <p className="text-sm sm:text-md text-gray-700 leading-relaxed mb-4 sm:mb-6">
            In the event of a disagreement between an Organizer and a Speaker, we provide a structured, three-stage resolution process:
          </p>
          
          <div className="space-y-4">
            <div className="bg-[#FF6B35]/10 p-3 sm:p-4 rounded-lg">
              <h3 className="text-base sm:text-lg font-semibold text-[#FF6B35] mb-2">Stage 1: Peer-to-Peer Resolution</h3>
              <p className="text-xs sm:text-sm text-[#FF6B35]">The parties are encouraged to communicate directly through our secure messaging system to reach an amicable solution.</p>
            </div>
            <div className="bg-[#FF6B35]/10 p-3 sm:p-4 rounded-lg">
              <h3 className="text-base sm:text-lg font-semibold text-[#FF6B35] mb-2">Stage 2: Platform Mediation</h3>
              <p className="text-xs sm:text-sm text-[#FF6B35]">If the parties cannot resolve the issue, either party may request mediation. A trained Voxvertex administrator will review the case, including all communications and documents, and propose a non-binding resolution.</p>
            </div>
            <div className="bg-[#FF6B35]/10 p-3 sm:p-4 rounded-lg">
              <h3 className="text-base sm:text-lg font-semibold text-[#FF6B35] mb-2">Stage 3: Formal Escalation</h3>
              <p className="text-xs sm:text-sm text-[#FF6B35]">If mediation fails, the funds will remain held in escrow, and we will provide both parties with a complete record of the transaction and communication to assist them in pursuing any legal remedies they may choose.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">8. Limitation of Liability & Disclaimer</h2>
          <p className="text-sm sm:text-md text-gray-700 leading-relaxed mb-4">
          ...
          <p className="text-xs sm:text-sm text-gray-700 bg-gray-50 p-3 sm:p-4 rounded-lg">
        ...
        {/* Governing Law */}
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">10. Governing Law & Jurisdiction</h2>
          <p className="text-sm sm:text-md text-gray-700 leading-relaxed mb-4">
        ...
        {/* Changes to Terms */}
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">11. Changes to Terms</h2>
          <p className="text-sm sm:text-md text-gray-700 leading-relaxed">
        ...
        {/* Contact Us */}
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">12. Contact Information</h2>
