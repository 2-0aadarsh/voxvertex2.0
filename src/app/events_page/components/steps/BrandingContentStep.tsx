...
export default function BrandingContentStep({ formData, onInputChange, onFormDataUpdate }: BrandingContentStepProps) {
  return (
    <div className="space-y-6 pl-6 pr-6">
        ...
        <div className="relative">
          ...
          <div className="border-2 border-dashed border-[#FF6B35] rounded-lg p-8 text-center bg-gray-50 pt-12">
            ...
            <input
              ...
              id="banner-image"
            />
            <label htmlFor="banner-image" className="cursor-pointer absolute inset-0"></label>
            {formData.image && (
      ...
      <div>
        <div className="relative">
          <label htmlFor="description" className="absolute left-4 -top-2 bg-white px-2 text-sm font-medium text-[#FF6B35] z-10">
            Event Description *
          </label>
          <textarea
            id="description"
