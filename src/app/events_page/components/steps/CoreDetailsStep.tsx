        ...
        {(formData.eventMode === 'online' || formData.eventMode === 'hybrid') && (
          <div className="w-full space-y-6 border-t border-gray-200 pt-8">
            ...
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-lg font-semibold text-[#FF6B35]">Online Event Platform</h3>
            </div>
            <p className="text-sm text-gray-600">Configure the online meeting platform and provide details that participants will need to join.</p>
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="relative w-full">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF6B35] focus:border-[#FF6B35] bg-white"
                  placeholder={isZoomSelected ? "123 456 789" : "Enter meeting ID (if applicable)"}
                />
              </div>
              <div className="relative w-full">
                <div className="flex items-center space-x-2 mb-1">
                ...
                <input
                  ...
                  required={isZoomSelected}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF6B35] focus:border-[#FF6B35] bg-white"
                  placeholder={isZoomSelected ? "Enter meeting passcode" : "Enter passcode (if applicable)"}
                />
              </div>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-sm text-blue-800 font-medium">For Organizers</p>
                  <p className="text-sm text-blue-700 mt-1">
                    These details will be sent to participants in their confirmation email and displayed on their event ticket. 
                    Make sure all information is accurate and test your meeting link before the event.
                  </p>
                </div>
              </div>
            </div>
